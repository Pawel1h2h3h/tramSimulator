...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout.addWidget(self.ModifyButton)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Tram Network Simulator", None))
        self.DefaultButton.setText(QCoreApplication.translate("MainWindow", u"Default Simulation", None))
        self.Open.setText(QCoreApplication.translate("MainWindow", u"Open", None))
        self.ModifyButton.setText(QCoreApplication.translate("MainWindow", u"Modify Simulation", None))
    # retranslateUi
